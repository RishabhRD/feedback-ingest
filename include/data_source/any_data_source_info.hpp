...
using with_data_source_info_t =
    rd::typelist_transform<rd::typelist<T...>, rd::data_source_info_t>::type;
...
static_assert(std::same_as<
              ...
              std::variant<rd::data_source_info_t<discourse::discourse_info_t>,
                           rd::data_source_info_t<int>>>);
} // namespace __details

using any_data_source_info_t =
