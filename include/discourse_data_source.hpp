...
raw_posts_to_schema(std::string_view str, std::string_view source_id,
...
fetch_posts_between(std::string_view source_id, std::string_view tenant_id,
                    int topic_id, std::chrono::system_clock::time_point begin,
                    std::chrono::system_clock::time_point end) {
  ...
  std::cout << post_ids_url_res << std::endl;
